...
from src.utils.data_utils import load_embedding_matrix


def create_default_model(config_data, nlabels):
    nb_filter = 200
    filter_length = 6
    ...
    softmax_layer1 = Dense(nlabels, activation='softmax', name='sentiment_softmax', init='lecun_uniform')(hidden)
